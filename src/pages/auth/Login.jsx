...
const Login = () => {
  return (
    <motion.div initial={{ opacity: 0, x: -100 }}
      ...
      exit={{ opacity: 0, x: 0 }}
      transition={{ duration: 0.2 }} className='flex  flex-col justify-center items-left pl-20 h-full'>
      <form className='flex flex-col gap-3 w-[400px]'>
        ...
        <div className='border-2 border-gray-500 p-2 rounded-sm flex gap-3'>
          ...
          <input type="password" name='password' placeholder='password' required className='bg-transparent border-l-2 border-gray-500 px-2 focus:border-[#eb5a44] w-4/5' />
        </div>
