...
const Hero = ({ heroImage, heroTitle }) => {
  return (
    <div>
      <div className="lg:w-[1200px] h-[550px] lg:h-[490px] overflow-hidden mx-auto mt-10 gap-10 bg-white px-5 lg:px-10 py-16 rounded-lg flex justify-between lg:items-start items-center">
        <div className="text-content text-black ">
          <h1 className="font-bold text-4xl lg:text-5xl mb-5 leading-10 lg:leading-14">{heroTitle}</h1>
